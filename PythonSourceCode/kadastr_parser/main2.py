...
def get_len_of_new_file():
    file = open("new_kadastr_29_10_2024.csv", "r")
...
def read_excel(file:str):
    with open(file) as file:
        ...
        return ["Ростовская область, "+line[0] for line in file][1:]
...
def main():
    addresses = read_excel("адрес_лс_нет кадастровых.csv")
    add_home(addresses)
    #print(*addresses,sep="\n")
    ...
    numbers = []
    new_file = open("new_kadastr_29_10_2024.csv", "a")
