...
public class UserGuideHTML {
    public static final String HTML_CONTENT = "<html>" +
            ...
            "<li style='margin-top: 10px;'>Ожидайте завершения процесса проверки. В конце вы увидите сообщения, что все файлы успешно обработаны. Они будут храниться в той же папке, что и выбранный Вами ранее zip-архив.</li>" +
